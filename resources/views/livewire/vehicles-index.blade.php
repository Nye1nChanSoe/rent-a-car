<div class="py-16 bg-zinc-50 dark:bg-zinc-900">
    <div class="container mx-auto px-6">
        ...
        <!-- Filters -->
        <div class="mt-6 bg-white dark:bg-black p-6 shadow-md rounded-lg">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <!-- Price Range -->
                <flux:input wire:model.debounce.500ms="priceMin" type="number" label="Min Price ($)" placeholder="0" />
                <flux:input wire:model.debounce.500ms="priceMax" type="number" label="Max Price ($)" placeholder="300" />
